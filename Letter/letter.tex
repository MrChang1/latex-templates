...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\lettertitle{Joe Jimmy Johnson}{color}{AbC, MSc}{1.0cm}
\positionedbox{left}{0.3\textwidth}{%
	\information{10, Street Name}{pic}{\faEnvelope~}\\
...
\positionedbox{right}{0.7\textwidth}{
	\information{+12 345 6789, +12 345 6789}{rightpic}{\faPhone~}\\%
	\information{\ 06.06.06.06.06}{rightpic}{{\Large\faMobilePhone}~}\\%
	\information{me@mail.com}{rightpic}{\faEnvelope~}\\%
	\information{~ }{space}{~ }\\
	\information{http://www.github.com}{rightpic}{\faGithub~}\\%
	\information{http://me.com}{rightpic}{ \faGlobe~} \\%
	}
